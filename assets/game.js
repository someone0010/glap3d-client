...
document.addEventListener( 'pointerlockchange', onPointerlockChange, false );
        ...
        var sunL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/sun/sun_ao.png") : null)
        })
        var mercL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/merc/merc_ao.png") : null)
        })
        var vensL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/vens/vens_ao.png") : null)
        })
        var erthL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/erth/erth_ao.png") : null)
        })
        var marsL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/mars/mars_ao.png") : null)
        })
        var juptL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/jupt/jupt_ao.png") : null)
        })
        var strnL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/strn/strn_ao.png") : null)
        })
        var urnsL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/urns/urns_ao.png") : null)
        })
        var neptL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/nept/nept_ao.png") : null)
        })
        var moonL = new THREE.MeshStandardMaterial({
            ...
            normalMap: ((settingsData["ptd"].current) ? txtl.load("assets/moon/moon_ao.png") : null)
        })
